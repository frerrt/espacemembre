...
?>
    ...
    <body>
        ...
        espace dedie aux <?php echo $role; ?>
    </body>
...
<?php
    ...
    echo "<center><span style='color:red;font-size:25px;font-weight:700;'>Vous devez etre membre pour pouvoir acceder à ce site!</span></center>";
}
?>